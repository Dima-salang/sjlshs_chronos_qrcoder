...
class QRCodeCrypto:
    ...
    def __init__(
        self, key: Optional[bytes] = None, key_file: str = "encryption_key.key"
    ):
    ...
    def encrypt_data(self, data: Dict[str, Any]) -> bytes:
        """Encrypt the data dictionary into a bytes string.

        Args:
            data: Dictionary containing the data to encrypt

        Returns:
            Bytes containing the encrypted data and nonce
        """
        ...
        # Return as bytes for encoding into the QR code
    ...
    def decrypt_data(self, encrypted_data: bytes) -> str:
        ...
        try:
            ...
            raise ValueError(
                "Decryption failed. The QR code may be corrupted or the key is incorrect."
            ) from e
